<template>
  <b-container class="validedemandeModal">
    <b-row>
      <b-col cols="12" class="text-center">
        <h2 class="mb-3">Validation de la valence Maître Nageur Aisance Aquatique de l'utilisateur <b>{{ formUser.prenom }} {{ formUser.nom }}</b>
        </h2>
      </b-col>
    </b-row>
    <b-row>
      <b-col cols="6">
        <b-form-group label="Date de début de formation :" class="mb-3 mt-3">
          <b-form-input
            readonly
            aria-describedby="inputFormatterHelp"
            v-model="formUser.datedebutformation"
            type="text"/>
        </b-form-group>
      </b-col>
      <b-col cols="6">
        <b-form-group label="Date de fin de formation :" class="mb-3 mt-3">
          <b-form-input
            readonly
            aria-describedby="inputFormatterHelp"
            v-model="formUser.datefinformation"
            type="text"/>
        </b-form-group>
      </b-col>
      <b-col cols="12">
        <b-form-group label="Lieu de formation :" class="mb-3 mt-3">
          <b-form-input
            readonly
            aria-describedby="inputFormatterHelp"
            v-model="formUser.lieuformation"
            type="text"/>
        </b-form-group>
      ...
      <b-col cols="12" class="text-left">
          <b-button v-on:click="$modal.hide('validedemande')">Annuler</b-button>
          <b-button variant="success" v-on:click="checkform">Valider la valence</b-button>
          <br/>
          <br/>
      </b-col>
    </b-row>
...
export default {
  ...
  methods: {
    ...
    if (!this.formUser.formateurid) {
        erreurformulaire.push("L'instructeur ayant assuré la formation est obligatoire");
        formOK = false;
      }
      /*
    ...
    renseignerinstructeur() {
      return (this.utilisateurCourant.profilId=="1" || this.utilisateurCourant.profilId=="6") 
    },
